...
test.describe('Featured 1 UP Test Suite', () => {
  ...
  test('Featured1UP - Validate Title, Dynamic Eyebrow, Page Title, Page Subtitle, Image, Graphics', async ({ page }) => {
  ...
  test('Featured1UP - Validate the animation', async ({ page }) => {
    ...
    const locator = page.locator('//*[@id="main-content"]/div[4]/div[4]/div[1]/a/div');
